...
const LogosHead = ({ fb_locale }, { t }) => (
  <Head>
    ...
    <meta
      name="description"
      content={t('Здесь можно скачать логотипы РКЦ в разных форматах')}
    />
    <meta property="og:url" content={`${hostName}/logo`} />
    <meta property="og:type" content="article" />
    <meta
      property="og:image"
      content="https://images.prismic.io/rqc1%2F53262c2e-fdd7-4d2e-b938-b3b6046c1b72_rqc_black_logo_rus.svg?auto=compress,format"
    />
    ...
    {(typeof fb_locale === 'undefined' || fb_locale === 'ru_RU') && (
      <>
        ...
        <meta
          ...
          content="Здесь можно скачать логотипы РКЦ в разных форматах"
        />
      </>
    )}
    {fb_locale === 'en_US' && (
      <>
        ...
        <meta
          property="og:description"
          content="Here you can download RQC logos in different graphical formats"
        />
      </>
    )}
  </Head>
