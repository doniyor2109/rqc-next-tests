...
class MainSlider extends React.Component {
  ...
  render() {
    ...
    const items = slides.map((slide) => {
      let back;
      if (phone) {
        back = { background: `url(${slide.primary.image_slide.iphone.url})`, backgroundSize: 'cover' };
      } else if (tablet) {
        back = { background: `url(${slide.primary.image_slide.ipad.url})`, backgroundSize: 'cover' };
      } else {
        back = { background: `url(${slide.primary.image_slide.url})`, backgroundSize: 'cover' };
      }
