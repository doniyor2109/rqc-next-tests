...
// если такое случается, помещаем публикацию в начало без журнала
const getJournalFirstLetter = pub => (pub.data.journal_name[0] && pub.data.journal_name[0].text) || 'Arxiv';
