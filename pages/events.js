...
class Events extends Component {
  ...
  componentDidMount() {
    this.props.fetchEvents(this.props.lang, this.state.pageSize, this.state.pageNumber)
  }
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.props.lang !== prevProps.lang) {
      ...
      switch (this.state.activeTag) {
        case 'SHOW_ALL':
          return this.props.fetchEvents(this.props.lang, this.state.pageSize, this.state.pageNumber)
        case 'SHOW_COLLOQUIUM':
          return this.props.fetchEventsByTag(this.context.t("коллоквиум"), this.state.pageSize)
        case 'SHOW_CONFERENCE':
          return this.props.fetchEventsByTag(this.context.t("конференция"), this.state.pageSize)
        // case 'SHOW_CHAMPIONSHIP':
        //   return this.props.fetchEventsByTag(this.context.t("Чемпионат"), this.state.pageSize)
        case 'SHOW_LECTURE':
          return this.props.fetchEventsByTag(this.context.t("лекция"), this.state.pageSize)
        default:
          return null
      }
    }
          ...
          <div className="eventspage">
            <div className="container">
              ...
              <div className="tags-for-search">
                ...
                <FilterTag onClick={e => {this.selectTag("SHOW_LECTURE", e)}}
                            active={this.state.activeTag === "SHOW_LECTURE" ? true : false}>
                  {this.context.t("лекция")}
                </FilterTag>
                <FilterTag onClick={e => {this.selectTag("SHOW_COLLOQUIUM", e)}}
                            active={this.state.activeTag === "SHOW_COLLOQUIUM" ? true : false}>
                  {this.context.t("коллоквиум")}
                </FilterTag>
                <FilterTag onClick={e => {this.selectTag("SHOW_CONFERENCE", e)}}
                            active={this.state.activeTag === "SHOW_CONFERENCE" ? true : false}>
              ...
              <Media  query="(max-width: 415px)"
                      ...
                      render={() => <Fragment>
                                      <GridViewMobile events={this.state.firstEvents}
                                                      isFetching={(this.props.events.isFetching || this.props.eventsbyTag.isFetching) && this.state.FetchFirst} />

                                      <MoreNews nextPage={this.state.nextPage}
                                                give_me_more_events={this.give_me_more_events}
                                                numberOfMoreNews={3}
                                                isFetching={(this.state.pageSize > 8) && (this.props.events.isFetching || this.props.eventsbyTag.isFetching)}
                                      />
                                    </Fragment>
                              }
              />
              ...
              <Media  query="(min-width: 416px) and (max-width: 768px)"
                      ...
                      render={() => <Fragment>
                                      <GridViewTablet events={this.state.firstEvents}
                                                      isFetching={(this.props.events.isFetching || this.props.eventsbyTag.isFetching) && this.state.FetchFirst} />
              ...
              <Media  query="(min-width: 769px)"
                      ...
                      render={() => <Fragment>
                                      <GridViewDesktop events={this.state.firstEvents}
                                                       isFetching={(this.props.events.isFetching || this.props.eventsbyTag.isFetching) && this.state.FetchFirst} />
                                      <MoreNews nextPage={this.state.nextPage}
                                                give_me_more_events={this.give_me_more_events}
                                                numberOfMoreNews={3}
