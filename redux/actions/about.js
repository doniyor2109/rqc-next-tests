...
const fetchAboutRequest = () => ({type: action_types.FETCH_ABOUT_REQUEST})

const fetchAboutSuccess = (response) => ({type: action_types.FETCH_ABOUT_SUCCESS, response}) 

const fetchAboutError = (error) => ({type: action_types.FETCH_ABOUT_FAILURE, error})
